...
namespace AssetBundleBrowser
{
    ...
    public class AssetBundleBrowserMain : EditorWindow, IHasCustomMenu, ISerializationCallbackReceiver
    {
        ...
        [SerializeField]
        AssetBundleConfigTab m_ConfigTab;
        ...
        private void OnGUI()
        {
            ...
            {
                case Mode.Config:
                    m_ConfigTab.OnGUI(GetSubWindowArea());
                    break;
                case Mode.Builder:
                    m_BuildTab.OnGUI();
                    break;
        ...
        void ModeToggle()
        {
            ...
            string[] labels = new string[4] {  "Browser", "Build", "Inspect","Configure"};
